...
if __name__ == "__main__":
    ...
    mesh = hpg.Mesh.from_array('T-junction', (4,3), [inlet, junction, main0, main1, None, branch0, None, None, None, branch1, None, None])
    ...
    xstretch = hpg.Geometric.from_delta(xunif.delta, 7*H, 0, main1.ni)
    xgrid = hpg.Composite([xunif, xstretch])
    yunif = hpg.Uniform.from_delta(delta, inlet.nj + branch0.nj)
    ystretch = hpg.Geometric.from_delta(yunif.delta, 7*H, 0, branch1.ni)
